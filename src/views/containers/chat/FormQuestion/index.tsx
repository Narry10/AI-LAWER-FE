...
import { ViewFactory } from "contexts/question/quesitionType";
  import { questionChangeView, questionUpdateForm } from "contexts/question/questionActions";
  ...
  const FormQuestion = () => {
    ...
    return (
      <div className="w-full flex flex-col">
        ...
        <div className="h-[80vh] bg-gray-800 w-full rounded-2xl p-2 overflow-auto">
          <Box
            component="form"
